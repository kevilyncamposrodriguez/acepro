...
final class SeminarsTable extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    ...
    {
        return Seminar::query()->where("team_id", Auth::user()->currentTeam->id);
    }
    ...
    */
    ...
    /**
     * PowerGrid seminar Action Rules.
     *
    ...
    public function actionRules(): array
    {
        return [
            ...
            Rule::button('edit')
                ->when(fn ($seminar) => $seminar->active == false)
                ->hide(),
            //Hides delete button when row is trashed
            Rule::button('delete')
                ->when(fn ($seminar) => $seminar->active == false)
            ...
            Rule::button('restore')
                ->when(fn ($seminar) => $seminar->active == true)
                ->hide(),
