...
<div class="py-2">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="grid grid-cols-12 gap-6 bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
            ...
            <div class="col-span-12 sm:col-span-4">
                <x-label for="course_image" value="{{ __('Imagen de publicidad (370X270)') }}" />
                <x-input id="course_image" type="file" accept="image/png,image/jpeg,image/jpg" class="mt-1 block w-full 'border-gray-300 focus:border-purple-950 focus:ring-purple-500 rounded-md shadow-sm'" wire:model="course_image" />
                <x-input-error for="course_image" class="mt-2" />
            </div>
            <div class="col-span-12 sm:col-span-4">
